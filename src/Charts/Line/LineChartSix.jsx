    ...
    return (
      <div>
        ...
        <Modal isOpen={this.state.modalIsOpen} onAfterOpen={this.afterOpenModal}
          ...
          <In val={this.state.y6} ph="X Val 6" onC={this.hC.bind(this, 'y6')} />
          <br />
          ...
          <In val={this.state.Cat1Box6} ph="Y Val 6" onC={this.hC.bind(this, 'Cat1Box6')} />
          <br />
          ...
          <In val={this.state.Cat2Box6} ph="Y Val 6" onC={this.hC.bind(this, 'Cat2Box6')} />
          <br />
