      ...
      >
        ...
        <input type="text" value={this.state.theDataMax} className="chartEditorInput chartEditorInputRight"
          ...
          <div className="amountWrap">
            ...
            <a href="/line/4"><button className="activeXAmount">4</button></a>
          ...
          <input type="text" value={this.state.y4} className="chartEditorInput chartEditorInputLeft"
            onChange={this.handleChange.bind(this, 'y4')} placeholder="X Value 4" /> <br />
          ...
          <input type="text" value={this.state.Cat1Box4} className="chartEditorInput chartEditorInputRight"
            onChange={this.handleChange.bind(this, 'Cat1Box4')} placeholder="Y Value 4" /> <br />
          ...
          <input type="text" value={this.state.Cat2Box4} className="chartEditorInput chartEditorInputRight"
            onChange={this.handleChange.bind(this, 'Cat2Box4')} placeholder="Y Value 4" /> <br />
